...
COMPARISON_OPERATOR = "<"
Z_CANDLE = 1
Z_VALUE_KEY = "LOW_PRICE"
Z_PATH = "CORE/DATA/YY_HISTORY_CANDLES.yaml"

SCRIPTS_TRUE = [
    "CORE/BACKEND/A_FLOW_BASED_LINE/C_CHECK/D_CHECK_HIGH_LOW_CROSS/DAABA_CHECK_STATUS_CROSSING_DOWN_RED.py",
]

SCRIPTS_FALSE = [
    "CORE/BACKEND/A_FLOW_BASED_LINE/C_CHECK/D_CHECK_HIGH_LOW_CROSS/DAABB_CHECK_STATUS_CROSSING_UP_RED.py",
]
