...
SCRIPTS_EQUAL: List[str] = [
    "CORE/TOOLS/msg_GREEN_DOWN_OPEN.py", 
    "CORE/TOOLS/ENABLE_GREEN_UP_OPEN.py",
    "CORE/TOOLS/DISABLE_GREEN_DOWN_OPEN.py",
    # ############
    "CORE/TOOLS/DISABLE_RED_DOWN_LOW.py",
    ...
    # ############
    "CORE/TOOLS/COPY_ORDER_SIDE_SELL.py",
    "CORE/TOOLS/COPY_ORDER_POSITION_SIDE_SHORT.py",
    "CORE/TOOLS/COPY_ORDER_TYPE_MARKET.py",
    # ############
    # "CORE/TOOLS/ORDER_BUY_SHORT.py",
    # "CORE/TOOLS/ORDER_SELL_LONG.py",
    # ###############################
]
