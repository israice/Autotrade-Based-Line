...
- ПОДГОТОВЛЕНО К НАЧАЛУ РАЗРАБОТКИ разместил файлы и папки до их осуществления 
...
```
git add .
git commit -m "ПОДГОТОВЛЕНО К НАЧАЛУ РАЗРАБОТКИ разместил файлы и папки до их осуществления"
git push
