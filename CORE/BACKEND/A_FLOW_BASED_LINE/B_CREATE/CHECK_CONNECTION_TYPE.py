...
CONFIG_HEADER = 'CONNECTION_TYPE'
SCRIPTS_UP_WORD = 'WEBSCOKET'
SCRIPTS_DOWN_WORD = 'REST'

SCRIPTS_YES = [
    'CORE/BACKEND/A_FLOW_BASED_LINE/B_CREATE/A_GET_WEBSOCKET_CANDLE/A_RUN.py',
]

SCRIPTS_NO = [
    "CORE/BACKEND/A_FLOW_BASED_LINE/B_CREATE/B_GET_REST_CANDLE/B_RUN_LOOP.py",
]
