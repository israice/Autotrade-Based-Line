...
# Script lists
SCRIPTS_UP = [
    "CORE/BACKEND/C_WORKFLOWS/A_FLOW_THE_OPEN_LINE/A_run.py",
    "CORE/BACKEND/C_WORKFLOWS/B_FLOW_HIGH_LOW_LINE/B_run.py",
    "CORE/BACKEND/C_WORKFLOWS/C_FLOW_CHERPAK_LINE/C_run.py",
]
SCRIPTS_DOWN = [
