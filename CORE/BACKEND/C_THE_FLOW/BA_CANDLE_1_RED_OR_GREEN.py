...
A_PATH = "CORE/DATA/YY_HISTORY_CANDLES.yaml"
A_VALUE_KEY = "CLOSE_PRICE"          # field to read from A file
A_CANDLE: Union[int, str] = 1      # index (int) or CANDLE value to match (any type)
COMPARISON_OPERATOR = "<"         # one of: '==', '!=', '>', '<', '>=', '<='
Z_CANDLE: Union[int, str] = 1      # index (int) or CANDLE value to match (any type)
...
SCRIPTS_EQUAL: List[str] = [
    "CORE/BACKEND/C_THE_FLOW/A_RED_UP_OPEN/A_run.py",
    "CORE/BACKEND/C_THE_FLOW/B_RED_DOWN_OPEN/B_run.py",
    # "CORE/BACKEND/C_THE_FLOW/FAA_RED_UP_LOW.py",
    # "CORE/BACKEND/C_THE_FLOW/FAB_RED_DOWN_LOW.py",
]
SCRIPTS_NOT_EQUAL: List[str] = [
    "CORE/BACKEND/C_THE_FLOW/C_GREEN_UP_OPEN/C_run.py",
    "CORE/BACKEND/C_THE_FLOW/D_GREEN_DOWN_OPEN/D_run.py",
    # "CORE/BACKEND/C_THE_FLOW/EAA_GREEN_UP_HIGH.py",
    # "CORE/BACKEND/C_THE_FLOW/EAB_GREEN_DOWN_HIGH.py",
