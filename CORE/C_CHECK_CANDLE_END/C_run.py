...
# Settings
LARGE_CANDLE_FILE = "CORE/B_GET_DATA/BA_get_large_candle.yaml"
CLONE_CANDLE_FILE = "CORE/Y_COPY_DATA/YA_clone_candles.yaml"
SCRIPTS_HIGH = [
    "CORE/C_CHECK_CANDLE_END/CAA_message_up.py",
    "CORE/Z_TOOLS/reset_config_lines.py", 
    "CORE/Z_TOOLS/reset_NOW_AMOUNT.py",  
    # "CORE/Z_TOOLS/order_sell_long.py",
]
SCRIPTS_LOW = [
    "CORE/C_CHECK_CANDLE_END/CBA_message_down.py",
    "CORE/Z_TOOLS/reset_config_lines.py",   
    "CORE/Z_TOOLS/reset_NOW_AMOUNT.py",  
