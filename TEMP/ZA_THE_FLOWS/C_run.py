...
# ###############################
CONFIG_PATH = 'CORE/DATA/workflows_config.yaml'
CONFIG_HEADER = 'WORKFLOWS'
SCRIPTS_UP_WORD = 'YES'
SCRIPTS_DOWN_WORD = 'NO'
# ###############################
# Script lists
SCRIPTS_UP = [
    "CORE/BACKEND/C_THE_FLOWS/A_FLOW_THE_OPEN_LINE/A_run.py",
    "CORE/BACKEND/C_THE_FLOWS/B_FLOW_HIGH_LOW_LINE/B_run.py",
    "CORE/BACKEND/C_THE_FLOWS/C_FLOW_CHERPAK_LINE/C_run.py",
]
SCRIPTS_DOWN = [
