...
OUTPUT_PATH = 'CORE/DATA/A_small_new_candles_data.yaml'  # Путь к выходному YAML-файлу
...
async def main():
    ...
    try:
        # Use custom SSL context with certifi to fix certificate issues in Python 3.12
        ...
        print("Binance временно не доступен")
        sys.exit(1)
...
print("- - B - - SMALL candles downloaded successfully.")
