...
SCRIPTS_UP_WORD = 'EASY'
SCRIPTS_DOWN_WORD = 'HARD'
...
SCRIPTS_YES = [
    ...
    "CORE/TOOLS/ENABLE_CROSSING_UP_GREEN.py",
    "CORE/TOOLS/DISABLE_CROSSING_DOWN_GREEN.py",
    "CORE/TOOLS/DISABLE_CROSSING_UP_RED.py",
    "CORE/TOOLS/ENABLE_CROSSING_DOWN_RED.py",
