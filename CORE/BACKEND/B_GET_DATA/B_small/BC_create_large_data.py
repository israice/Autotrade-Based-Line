...
YAML_PATH_CANDLES_1 = 'CORE/DATA/E_large_old_candles_data.yaml'
KEY_PERCENTAGE_CHANGE = 'PERCENTAGE_CHANGE_LARGE'
KEY_TREND = 'TREND_LARGE'
...
print("- - B - - LARGE data created successfully.")
