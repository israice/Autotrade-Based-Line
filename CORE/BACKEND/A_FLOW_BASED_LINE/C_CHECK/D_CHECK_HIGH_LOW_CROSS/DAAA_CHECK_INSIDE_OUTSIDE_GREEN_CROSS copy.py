...
SCRIPTS_EQUAL: List[str] = [
    "CORE/BACKEND/A_FLOW_BASED_LINE/C_CHECK/D_CHECK_HIGH_LOW_CROSS/DAAAA_CHECK_STATUS_CROSSING_UP_GREEN.py",
    
]
SCRIPTS_NOT_EQUAL: List[str] = [
    "CORE/BACKEND/A_FLOW_BASED_LINE/C_CHECK/D_CHECK_HIGH_LOW_CROSS/DAAAB_CHECK_STATUS_CROSSING_DOWN_GREEN.py",
]
