...
OUTPUT_PATH = 'CORE/DATA/B_large_new_candles_data.yaml'  # Путь к выходному YAML-файлу
...
interval = settings['sell_interval']
...
print("- - B - - LARGE candles downloaded successfully.")
