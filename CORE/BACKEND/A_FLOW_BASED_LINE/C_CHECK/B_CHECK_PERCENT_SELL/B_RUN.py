...
SCRIPTS_YES = [
    "CORE/BACKEND/A_FLOW_BASED_LINE/C_CHECK/B_CHECK_PERCENT_SELL/BA_CREATE_PERCENT.py", 
    "CORE/BACKEND/A_FLOW_BASED_LINE/C_CHECK/B_CHECK_PERCENT_SELL/BB_if_percent_positive_or_negative.py", 
]
