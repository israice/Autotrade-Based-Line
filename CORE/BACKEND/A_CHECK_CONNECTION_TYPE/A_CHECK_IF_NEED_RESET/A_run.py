...
SCRIPTS_YES = [
    'CORE/BACKEND/A_CHECK_CONNECTION_TYPE/A_CHECK_IF_NEED_RESET/AA_HARD_RESET.py',
]

SCRIPTS_NO = [
    'CORE/BACKEND/A_CHECK_CONNECTION_TYPE/A_CHECK_IF_NEED_RESET/AB_EASY_RESET.py',
]
