...
YAML_PATH_TREND = 'CORE/DATA/C_temp_config.yaml'
YAML_PATH_CANDLES_0 = 'CORE/DATA/A_small_new_candles_data.yaml'
YAML_PATH_CANDLES_1 = 'CORE/DATA/D_small_old_candles_data.yaml'
KEY_PERCENTAGE_CHANGE = 'PERCENTAGE_CHANGE_SMALL'
KEY_TREND = 'TREND_SMALL'
...
print("- - B - - SMALL data created successfully.")
