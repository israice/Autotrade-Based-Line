...
YAML_REL_PATH = 'CORE/DATA/B_large_new_candles_data.yaml'
CANDLE_0_OPEN_KEY = 'candle_0_open'
CANDLE_1_OPEN_KEY = 'candle_1_open'
YAML_ENCODING = 'utf-8'
SCRIPT_LONG = 'CORE/BACKEND/C_CHECK_CANDLE_END/CAA_SELL_LONG.py'
SCRIPT_SHORT = 'CORE/BACKEND/C_CHECK_CANDLE_END/CAB_SELL_SHORT.py'
