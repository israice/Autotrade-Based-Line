...
CANDLE_FILE_PATH = 'CORE/DATA/AA_CANDLE.yaml'
CANDLE_0_CLOSE_KEY = 'candle_0_close'
CANDLE_1_HIGH_KEY = 'candle_1_high'
GREEN_SCRIPT_PATHS = [
    "CORE/BACKEND/F_CHECK_HIGH_LOW_CROSS/FAAAA_check_status_CROSSING_UP_GREEN.py",
]
RED_SCRIPT_PATHS = [
    "CORE/BACKEND/F_CHECK_HIGH_LOW_CROSS/FAAAB_check_status_CROSSING_DOWN_GREEN.py",
]
