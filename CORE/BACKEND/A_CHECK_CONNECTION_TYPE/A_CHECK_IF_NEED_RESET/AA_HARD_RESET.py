...
SCRIPTS_UP_WORD = 'HARD'
SCRIPTS_DOWN_WORD = 'EASY'

SCRIPTS_YES = [
    "CORE/TOOLS/GET_INFO_FOR_ORDER_BODY.py",
    # ############# RESET DB #####################
    "CORE/TOOLS/RESET_HISTORY_FILE.py",
    "CORE/TOOLS/GET_CANDLE_1.py",
    "CORE/TOOLS/RESET_AA_ZZ_CANDLES_FILES.py",
    # #########################
    "CORE/TOOLS/RESET_COUNTER_HIGH_CROSSING.py",
    "CORE/TOOLS/RESET_COUNTER_OPEN_CROSSING.py",
    "CORE/TOOLS/RESET_COUNTER_LOW_CROSSING.py",
    "CORE/TOOLS/RESET_PERCENT_SELL.py",
    # #######################################################
    "CORE/TOOLS/ENABLE_RED_UP_OPEN.py",
    "CORE/TOOLS/DISABLE_RED_DOWN_OPEN.py",
    "CORE/TOOLS/DISABLE_GREEN_UP_OPEN.py",
    "CORE/TOOLS/ENABLE_GREEN_DOWN_OPEN.py",
    # #######################################################
    "CORE/TOOLS/ENABLE_GREEN_UP_HIGH.py",
    "CORE/TOOLS/DISABLE_GREEN_DOWN_HIGH.py",
    "CORE/TOOLS/DISABLE_RED_UP_LOW.py",
    "CORE/TOOLS/ENABLE_RED_DOWN_LOW.py",
    # #######################################################
    "CORE/TOOLS/COPY_AA_TO_ZZ.py",
]
