...
GREEN_LIST = [
    "CORE/BACKEND/Z_TOOLS/add_1_to_COUNTER_OPEN_LINE.py",
    "CORE/BACKEND/Z_TOOLS/message_open_line_crossing_up.py",
]
RED_LIST = [
    "CORE/BACKEND/Z_TOOLS/add_1_to_COUNTER_OPEN_LINE.py",
    "CORE/BACKEND/Z_TOOLS/message_open_line_crossing_down.py",
]
GREEN_STATUS = 'GREEN'
RED_STATUS = 'RED'
